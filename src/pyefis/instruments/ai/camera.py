...
def view_projection(ac_e, ac_n, ac_u, heading_deg, pitch_deg, roll_deg,
    ...
    *pixels_per_deg_h* (AER-1799 eval) lets the horizontal (terrain
    HFOV) scale be set independently of the vertical pitch-ladder
    scale; None (every existing call site) keeps them equal, i.e. the
    coupling this parameter exists to let a caller break.
    """
